...
namespace EmployeeSales
{
    ...
    public partial class Window1 : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                string reportPath = @"..\..\..\..\..\..\Common\Data\ReportTemplate\Employee Sales Summary.rdl";
                ...
                {
                    fileName = "Employee Sales.pdf";
                    format = WriterFormat.PDF;
                }
                else if (word.IsChecked == true)
                {
                    fileName = "Employee Sales.docx";
                    format = WriterFormat.Word;
                }
                else if (excel.IsChecked == true)
                {
                    fileName = "Employee Sales.xlsx";
                    format = WriterFormat.Excel;
                }
                else
                {
                    fileName = "Employee Sales.html";
