...
namespace GroupingTable
{
    public sealed partial class ReportViewerPage : Page
    {
        ...
        private void ReportViewerPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Stream reportStream = assembly.GetManifestResourceStream("GroupingTable.ReportTemplate.Grouping Table.rdlc");
        ...
        {
            this.ReportViewer.DataSources.Add(new ReportDataSource { Name = "Customers", Value = ReportData.Customers.GetData() });
        }
    }
}
