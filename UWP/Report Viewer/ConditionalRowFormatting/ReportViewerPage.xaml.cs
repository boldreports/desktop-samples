...
namespace ConditionalRowFormatting
{
    public sealed partial class ReportViewerPage : Page
    {
        ...
        private void ReportViewerPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Stream reportStream = assembly.GetManifestResourceStream("ConditionalRowFormatting.ReportTemplate.ConditionalRowFormatting.rdlc");
        ...
        {
            this.ReportViewer.DataSources.Add(new ReportDataSource { Name = "CustomerDetail", Value = ReportData.CustomerDetails.GetData() });
        }
    }
}