...
namespace IndicatorReport
{
    public sealed partial class ReportViewerPage : Page
    {
        ...
        private void ReportViewerPage_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            Stream reportStream = assembly.GetManifestResourceStream("IndicatorReport.ReportTemplate.IndicatorReport.rdlc");
        ...
        {
            this.ReportViewer.DataSources.Add(new ReportDataSource { Name = "DataSet1", Value = ReportData.Billionaires.GetList_2013() });
            this.ReportViewer.DataSources.Add(new ReportDataSource { Name = "DataSet2", Value = ReportData.Billionaires.GetList_2012() });
            this.ReportViewer.DataSources.Add(new ReportDataSource { Name = "DataSet3", Value = ReportData.Indicator.GetIndicator() });
        }
    }
}
